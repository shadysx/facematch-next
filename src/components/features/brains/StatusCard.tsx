...
const BrainStatusCard = (props: StatusCardProps) => {
  ...
  return (
    <Card
      className={`border-0 relative overflow-hidden w-[140px] h-[52px]
            ${
              isReady
    ...
    >
      ...
      {isTraining && (
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent, rgb(147, 51, 234), rgb(59, 130, 246), transparent)",
